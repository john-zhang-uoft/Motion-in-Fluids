...
# data = pd.read_csv('Oil.txt', header=0)
#
...
# radius = diameter/2
#
# plt.scatter(x=unumpy.nominal_values(radius), y=unumpy.nominal_values(velocity), color='blue')
# plt.title('Terminal Velocity vs Bead Radius for Glycerine')
# plt.xlabel('Bead Radius (m)')
# plt.ylabel('Terminal Velocity (m/s)')
# plt.show()


data = pd.read_csv('Oil_no_outliers.txt', header=0)
